...
// ⚙️ GAME SETTINGS
// ==========================================
const QUESTIONS_PER_ROUND = 5; // Game picks 5 random questions from the pool
...
const campaignData = {
    Math: [
      { 
        level: 1, 
        title: "Mental Math", 
        // Added extra questions here to demonstrate the randomization pool
        questions: [ 
...
export default function QuizApp() {
  ...
  const startGame = (cat, lvlIdx) => {
    ...
    // If the list is smaller than the limit, it just takes them all in random order
